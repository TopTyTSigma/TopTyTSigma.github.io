    ...
    <div className='app-container'>
      ...
      <div className={`main-container ${entered ? 'entered' : ''}`}>
        ...
        <div className='song'>
          ...
          <a href='https://soundcloud.com/t7o/yashenka-otvratitelno' target='_blank' rel='noopener noreferrer'>
            <img src={cover} className='songcover' alt='' />
          </a>
          <div className='songinfo'>
            <p1 className='songtitle'>Yashenka</p1>
            <p1 className='artist'>by Kankan</p1>
            <p1 className='album' href>on Yashenka</p1>
          </div>
